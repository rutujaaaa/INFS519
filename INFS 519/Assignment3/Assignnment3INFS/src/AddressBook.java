...
public class AddressBook {
	...
	public static void main(String[] args) throws IOException {
		...
		switch(input1) {
		case "yes": String fileName = "/Users/rutujajadhav/eclipse-workspace_519/Assignnment3INFS/contact.txt";  // name of the file
		...
		while (true) {
			...
			case "a":
				...
				System.out.print(addressBook.displayAll());
				break;
			case "q":
				addressBook.save();
				System.exit(0);
